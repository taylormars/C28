...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button buttonPause = (Button) findViewById(R.id.buttonp);
        final Button buttonStop = (Button) findViewById(R.id.buttonst);
        final Button buttonLoop = (Button) findViewById(R.id.buttonll);
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    AssetFileDescriptor assetFileDescriptor = assetManager.openFd("01 When I Was Your Man.m4a");
